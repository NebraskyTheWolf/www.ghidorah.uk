                    ...
                    <tbody>
                        @foreach ($contests as $contest)
                            <tr>
                                ...
                                <td>
                                    {{ $contest->registeredAt->diffForHumans() }}
                                </td>
                                <td>
...
@section('script')
    <script type="text/javascript">
        $('button[data-sanction]').on('click', function (e) {
            ...
            $('[data-sanction-info="date"]').html(sanction.creation_date)
            ...
            // staff
            $('[data-sanction-info="staff-username"]').html((sanction.punisher_uuid == '00000000000000000000000000000000' ? "FOXGUARD" : sanction.by))
            ...
            if (sanction.expiration_date === 'PERMANENT')
                ...
                $('.sanction-duration').html(formatSeconds(sanction.expiration_date))
            }
