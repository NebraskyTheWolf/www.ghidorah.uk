...
@section('content')
  <div class="ui container page-content">
    ...
    <h1 class="ui center aligned header">
      <img class="ui rounded image" src="{{ $discordUser['user']['avatar'] }}">
      <div class="content">
        {{ Auth::user()->username }}
          ...
          <div data-menu="infos">
            <div class="ui form">
              ...
              <div class="field">
                ...
                <div class="fields">
                  <div class="twelve wide field">
                    <input type="text" id="discordid" value="{{ Auth::user()->discord_id }}" disabled>
                  </div>
                </div>
              </div>
              <div class="field">
          ...
          <div data-menu="security" style="display:none;">
            <div class="ui info icon message">
              ...
              <div class="content">
                ...
                <p>@lang('user.two_factor_auth.subtitle', ['link' => 'https://skf-studios.com/2fa-guide'])</p>
                @if (!$twoFactorEnabled)
            ...
            <div id="obsiguardDisabled" style="display:{{ count($findObsiGuardIPs) <= 0 ? 'block' : 'none' }};">
              <div class="ui info icon message">
                ...
                <div class="content">
                  ...
                  <p>@lang('user.obsiguard.subtitle', ['link' => 'https://skf-studios.com/foxguard-guide'])</p>
          ...
          <div data-menu="socials" style="display:none;">
            ...
            @ability('', 'user-link-google-account,user-youtube-view-own-videos,user-youtube-get-remuneration')
              ...
              <div class="text-center">
                <a href="{{ ($youtube > 0) ? url('/user/socials/youtube/videos') : url('/user/socials/google/link') }}" class="ui youtube button">
